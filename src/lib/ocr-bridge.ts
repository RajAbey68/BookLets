...
// E5 / P1.4: the service-identity literal lives ONLY in maker-identity.ts —
// assign from the shared constant (the governance gate greps src/ for stray
// literals) while keeping this export name for existing consumers/tests.
export const OCR_BRIDGE_MAKER = AUTOMATION_MAKER_IDENTITY;
